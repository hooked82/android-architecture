...
class CharacterPagedListAdapter(context: Context)
    : BasePagedListAdapter<Character, BasePagedListAdapter.OnItemClickListener<Character>, CharacterViewHolder>(context, Character.diffCallback) {

    private var mHasReachedEnd: Boolean = false
